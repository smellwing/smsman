...
<div class="row">
    <div class="columns large-12">
        <div class="ctp-warning alert text-center">
            <p><?=utf8_encode('Recuerde revisar la carga antes de enviar una campaña.')?></p>
        </div>
...
<div class="row">
    <div class="columns large-6">
        <h4>CARGA ACTUAL</h4>
        <ul>
            <li class="bullet success"><?= utf8_encode('En este momento hay unaa carga mínima de ')."$cargaHoraActiva.";?></li>
